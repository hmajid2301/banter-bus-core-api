...
WORKDIR /app
EXPOSE 8080
CMD uvicorn app:app --host ${BANTER_BUS_CORE_API_WEB_HOST} --port ${BANTER_BUS_CORE_API_WEB_PORT} --app-dir /app
...
WORKDIR /app
EXPOSE 8080
CMD uvicorn --reload app:app --host ${BANTER_BUS_CORE_API_WEB_HOST} --port ${BANTER_BUS_CORE_API_WEB_PORT} --app-dir /app
